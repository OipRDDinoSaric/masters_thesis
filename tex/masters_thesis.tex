...
\keywords{Functional safety, IEC 61508,IEC 26262, bootloader, certification, ARM Cortex R, Cortex R, FreeRTOS, Cortex M, kernel, redudancy, lock-step}
\end{abstract}
...
\kljucnerijeci{Funkocionalna sigurnost, IEC 61508, IEC 26262, bootloader, certifikacija, ARM, Cortex R, FreeRTOS, Cortex M, jezgra, redundancija}
\end{sazetak}
